...
const {setColor, setMode, currentMode, currentColor, setThemeSetting} = useStateContext()
  ...
  return (
    <section className="bg-half-transparent w-screen fixed nav-item top-0 right-0  ">
              ...
              themeColors.map((item, index) => (
                <TooltipComponent key={index} content={item.name} position="TopCenter">
                  <div className="relative mt-2 cursor-pointer flex gap-5 items-center ">
                    <button type="button" className="h-10 w-10 fcursor-pointer rounded-full" style={{backgroundColor: item.color}}
